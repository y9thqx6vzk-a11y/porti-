        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center space-y-8 scroll-reveal">
            ...
            <div className="space-y-6 text-slate-650 dark:text-slate-350 text-base leading-relaxed font-sans font-light">
              <p>
                I help find simple, creative solutions to support my team. A key part of this is building strong international B2B partnerships. For example, collaborating with a local travel agent for my current project, a 10-day boutique expedition to Sri Lanka for 10-20 clients, required building absolute trust while ensuring standards never dropped. This approach helped me navigate complex logistical and financial challenges, such as securing 100% kosher food in a country where seafood and dairy are standard breakfast fare, and navigating creative tax solutions to manage high upfront hotel expenses for our small business.
              </p>
              <p>
                I have always loved envisioning the full picture and translating it into practical steps, an analytical tendency that also led me to study Mathematics at Ben-Gurion University of the Negev. In the military, planning daily operations for 140 soldiers and orchestrating events of up to 3,000 participants, I learned the critical value of meticulous planning. I dive into the smallest details, from securing field supplies in the middle of nowhere to designing our project website.
              </p>
              <p>
